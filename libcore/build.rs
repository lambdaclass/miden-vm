...
pub fn build_libcore_docs(asm_dir: &Path, output_dir: &str) -> io::Result<()> {
...
fn main() -> Result<(), Report> {
    ...
    if std::env::var("MIDEN_BUILD_LIBCORE_DOCS").is_ok() {
        build_libcore_docs(&asm_dir, DOC_DIR_PATH).into_diagnostic()?;
    }
